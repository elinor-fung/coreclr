...
FCFuncStart(gAssemblyLoadContextFuncs)
    ...
    QCFuncElement("FireResolvingHandlerInvoked", AssemblyNative::FireResolvingHandlerInvoked)
FCFuncEnd()
...
FCFuncStart(gAssemblyFuncs)
    ...
    FCFuncElement("IsBinderTracingEnabled", AssemblyNative::IsBinderTracingEnabled)
